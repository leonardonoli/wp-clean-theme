...
function update_notifier() { 
	...
	<div class="wrap">
        ...
        <div id="instructions" style="max-width: 800px;">
            ...
            <p>To update the Theme, download the theme by clicking <a href="http://amilliamilli.com/theme_updater/clean.zip" target="_blank">here</a>.</p>
...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'http://amilliamilli.com/theme_updater/notifier.xml';
